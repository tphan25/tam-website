          ...
          <Grid container>
            <Grid item xs={12}>
              ...
              <Typography variant="h3" className={classes.text}>
                ...
                bachelor's degree at Virginia Tech. I'm looking for an
                internship :^) in Summer 2020 too, before I begin my accelerated
                master's degree (expected May 2021)
              </Typography>
              <Box
                display="flex"
                alignItems="stretch"
              ...
              <Typography variant="h3" className={classes.text}>
                ...
                amateur), and playing video games/watching shows. I used to play
                a lot of League of Legends, and even hosted/streamed a
                tournament with 50 participants last year over multiple weeks.
              </Typography>
              <Box
                display="flex"
                alignItems="stretch"
              ...
              <Typography variant="h3" className={classes.text}>
                I'm also active in large student organizations like KASA at VT
                (Korean American Student Association) as their current Vice
                President, previously the Events Coordinator.
              </Typography>
              <Box
                display="flex"
                alignItems="stretch"
